		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoices List",
									"targetURL": "#hcdsolucionesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hcdsolucionesinvoices-display": {
								"semanticObject": "hcdsolucionesinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hcdsoluciones.invoices",
									"url": sap.ui.require.toUrl("hcdsoluciones/invoices")
								}
							}
						}
					}
